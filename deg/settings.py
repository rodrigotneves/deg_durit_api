"""
Django settings for deg project.
...
SECRET_KEY = (
    "django-insecure-b)#a-a_t-c@lz7x^(+mw^g@@&p(ucy%u&dw8dxrrypttqcl1v$"  # noqa
)
...
WSGI_APPLICATION = "deg.wsgi.application"
